...
#[derive(Debug)]
pub struct UserPortalProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UserPortalProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UserPortal processing");
    
    let mut processor = UserPortalProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UserPortalProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UserPortalProcessor::new(false);
